...
const PengaduanCardSkeleton = () => (
    <View style={styles.card}>
        ...
        <View style={styles.cardFooter}>
            <SkeletonShimmer style={{ width: 180, height: 12 }} />
        </View>
    </View>
);
...
export default function PengaduanListScreen() {
    ...
    const renderItem = ({ item }: { item: any }) => (
        <TouchableOpacity
            style={styles.card}
            onPress={() => navigation.navigate('PengaduanDetail', { item })}
        >
            <View style={styles.cardHeader}>
                <View style={styles.userInfo}>
            ...
            <View style={styles.cardFooter}>
                <Text style={styles.detailLink}>Lihat Detail Bureaucracy & Tracking</Text>
                <Icon name="arrow-forward" size={12} color="#F59E0B" />
            </View>
        </TouchableOpacity>
    );
                    ...
                    ListEmptyComponent={
                        !loading ? (
                            <View style={styles.emptyContainer}>
                                ...
                                <Text style={styles.emptyText}>Belum ada pengaduan terkini</Text>
                            </View>
                        ) : null
                    }
                />
